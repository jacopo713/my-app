  ...
  const handleRegistration = async (
    ...
    try {
      ...
      if (provider === 'google') {
        ...
        if (!credentials) throw new Error('Dati di accesso mancanti');
  ...
  return (
    <div className="max-w-4xl mx-auto px-4">
      <div className="bg-white rounded-xl shadow-lg p-8 relative">
        ...
        {user ? (
          // Mostra i risultati del test se l'utente è autenticato
          ...
          // Se l'utente non è autenticato, mostra il form di registrazione inline
          <div className="max-w-md w-full mx-auto space-y-8 p-8 bg-gray-50 rounded-xl shadow-lg">
