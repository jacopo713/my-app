...
const PrivacyPolicy = () => {
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto', lineHeight: '1.6' }}>
      ...
      <p>Possiamo raccogliere le seguenti informazioni personali:</p>
      <ul>
        <li><strong>Informazioni di contatto</strong>: Nome, indirizzo email, numero di telefono.</li>
        <li><strong>Informazioni di pagamento</strong>: Dettagli della carta di credito o altri metodi di pagamento (gestiti tramite Stripe).</li>
        <li><strong>Informazioni tecniche</strong>: Indirizzo IP, tipo di browser, sistema operativo, dati di utilizzo del sito.</li>
      </ul>
      ...
      <h2>4. Come Utilizziamo le Informazioni</h2>
      ...
      <ul>
        ...
        <li>Comunicare con te, ad esempio per inviarti aggiornamenti o rispondere alle tue richieste.</li>
        <li>Rispettare obblighi legali e regolamentari.</li>
      </ul>

      <h2>5. Condivisione delle Informazioni</h2>
      ...
      <p>Adottiamo misure di sicurezza tecniche e organizzative per proteggere le tue informazioni personali da accessi non autorizzati, uso improprio o perdita. Tuttavia, nessun sistema è completamente sicuro, e non possiamo garantire la sicurezza assoluta dei dati.</p>

      <h2>7. Conservazione dei Dati</h2>
      <p>Conserviamo i tuoi dati personali solo per il tempo necessario a raggiungere le finalità per cui sono stati raccolti, salvo quando la legge richiede o permette un periodo di conservazione più lungo.</p>
      ...
      <ul>
        ...
        <li><strong>Cancellazione</strong>: Richiedere la cancellazione dei tuoi dati in determinate circostanze.</li>
        <li><strong>Limitazione</strong>: Limitare il trattamento dei tuoi dati in determinate circostanze.</li>
        <li><strong>Portabilità</strong>: Ricevere i tuoi dati in un formato strutturato e trasferirli a un altro titolare del trattamento.</li>
