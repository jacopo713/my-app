Tempo di ragionamento: 2.5 secondi
Collegamenti: 6
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="flex items-center space-x-8">
              ...
              {/* Link Desktop */}Tempo di ragionamento: 2.5 secondi
Collegamenti: 6
      ...
      <main className="pt-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div
            ...
            style={{
              backgroundImage:
                "url('https://images.unsplash.com/photo-1614289078003-fb2ad21bcf8f?auto=format&fit=crop&w=1300&q=80')",
            }}
          >
            {/* Overlay */}
            ...
            <div className="relative z-10 flex flex-col lg:flex-row items-center">
              ...
              <div className="lg:w-1/2 grid grid-cols-2 gap-3 sm:gap-4 mt-6 lg:mt-0">
                <div className="bg-gradient-to-br from-blue-600/20 to-blue-800/30 backdrop-blur-sm p-4 rounded-lg hover:from-blue-600/30 hover:to-blue-800/40 transition-all">
                  ...
                  <p className="text-xs text-white/90">Matrici progressive</p>
                </div>
                <div className="bg-gradient-to-br from-purple-600/20 to-purple-800/30 backdrop-blur-sm p-4 rounded-lg hover:from-purple-600/30 hover:to-purple-800/40 transition-all">
                  ...
                  <p className="text-xs text-white/90">Occhio-mano</p>
                </div>
                <div className="bg-gradient-to-br from-emerald-600/20 to-emerald-800/30 backdrop-blur-sm p-4 rounded-lg hover:from-emerald-600/30 hover:to-emerald-800/40 transition-all">
                  ...
                  <p className="text-xs text-white/90">Comprensione testuale</p>
                </div>
                <div className="bg-gradient-to-br from-amber-600/20 to-amber-800/30 backdrop-blur-sm p-4 rounded-lg hover:from-amber-600/30 hover:to-amber-800/40 transition-all">
                  ...
                  <p className="text-xs text-white/90">Sincronizzazione</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-xl shadow-lg p-6 sm:p-8 mb-12">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              ...
              >
                ...
                <p className="text-gray-600">Valutazione su più abilità cognitive</p>
              </div>// app/page.tsx
'use client';
...
Ho mantenuto esattamente lo stesso layout del codice originale, sostituendo solo le classi dei colori dei pannelli delle anteprime dei test con i nuovi gradienti colorati. Il resto del codice è identico all'originale.
              <div className="hidden md:flex items-center space-x-4">
