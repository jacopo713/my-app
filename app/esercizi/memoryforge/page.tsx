          ...
          <div className="bg-white rounded-xl shadow-lg p-6">
            ...
            <div className="flex justify-between items-center mb-6">
              <div className="flex items-center gap-2">
                ...
                <div>
                  <h1 className="text-2xl font-bold">Memory Forge</h1>
                  <p className="text-sm text-gray-600">Potenzia la tua memoria</p>
                </div>
              </div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
              <div className="bg-gray-50 p-4 rounded-lg">
                ...
                <div className="text-xl font-bold text-blue-600">{gameState.level}</div>
              </div>
              <div className="bg-gray-50 p-4 rounded-lg">
              ...
              <div className="bg-gray-50 p-4 rounded-lg">
                ...
                <div className="text-xl font-bold text-purple-600">{gameState.highScore}</div>
              </div>
              <div className="bg-gray-50 p-4 rounded-lg">
                <div className="text-sm text-gray-600">Livello Max</div>
                <div className="text-xl font-bold text-orange-600">{gameState.maxLevel}</div>
              </div>
            </div>

            {/* Griglia di gioco */}
            <div className="aspect-square w-full max-w-2xl mx-auto mb-6">
              <div 
              ...
              {!gameState.isPlaying && (
                <button
                  ...
                  className="px-6 py-3 bg-blue-600 text-white rounded-lg
                           hover:bg-blue-700 transition-colors inline-flex 
                           items-center gap-2"
                >
